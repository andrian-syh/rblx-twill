...
moderator can settle it in front of them, and nothing about the answer depends
on either of them trusting the other.
...
`Player`. The documentation site [already said so](/reference/troubleshooting/);
